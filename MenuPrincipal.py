...
class FormularioFarmacia:
    def __init__(self, master):
        ...
        self.button2state = tk.Button(self.master, text="REPOSICION", command=self.AbrirVentanaReposicion, height=4,
                                       width=20, )
    ...
    def ventanamed(self):
        ...
        self.show_frame()
        self.tkLabel2 = ttk.Label(self.newWindow, text="Los datos correspondientes al codigo QR son:")
        self.tkLabel2.pack()
    ...
    def solicitar(self):
        ...
        if int(respuesta[0][3])> 0: #Existe el producto
            if int(respuesta[0][3]) < int(datos[0]):
                mb.showinfo("Informacion", "No existe cantidad de medicamentos solicitados")
                self.cantidadcarga.set("")
            else:
                ...
                #mb.showinfo("Informacion", "Su pedido se esta procesando, aguarde")
                self.tarea=0
    ...
    def ventanaprocess(self):
        ...
        if (self.tarea==0):
            ...
            self.estado.set("AGUARDE, YA ESTA PREPARaNDOSE SU PEDIDO")
        elif (self.tarea==1):
    ...
    def ventanarepon(self):
        ...
        self.newWindow2.title("VENTANA DE REPOSICIoN")
        ...
        self.CamReposicion()
        self.tkLabel2 = ttk.Label(self.newWindow2, text="Los datos correspondientes al cOdigo QR son:")
        self.tkLabel2.pack()
    ...
    def cargar(self):
        ...
        if (len(respuesta)>0):  # Verifica si existe el medicamento
            ...
            mb.showinfo("Informacion", "No se encuentra registrado el producto")
        self.t4 = None
        self.t4 = threading.Thread(target=self.cargar)
